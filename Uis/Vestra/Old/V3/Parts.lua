local ui = library:Init('UI Title')
...
local storeDropdown
storeDropdown = Objects:Dropdown('Exploits', 'exploits', {'Script-Ware', 'ProtoSmasher', 'Synapse X', 'Elysian', 'KRNL', 'Fluxus', 'Shadow', 'Sentinel', 'Intriga'}, function(selected) -- string <text>, string <flag>, table <options>, function [callback]
    print(selected)
